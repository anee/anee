...
CREATE TABLE `photo` (
  ...
  CONSTRAINT `FK_14B784185ED23C43` FOREIGN KEY (`track_id`) REFERENCES `track` (`id`),
...
(1,	5,	41,	'2014-06-28 17.25.09 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-28 17.25.09 HDR.jpg',	'2014-06-28 14:23:09',	1),
(5,	3,	NULL,	'2014-06-06 23.09.42.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-06 23.09.42.jpg',	'2014-06-06 23:09:42',	1),
(6,	3,	NULL,	'2014-05-13 18.31.51.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-05-13 18.31.51.jpg',	'2014-05-13 18:31:51',	1),
(7,	3,	NULL,	'2014-04-15 18.10.17.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-04-15 18.10.17.jpg',	'2014-04-15 18:14:36',	1),
(8,	3,	NULL,	'2014-06-15 19.44.57 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-15 19.44.57 HDR.jpg',	'2014-06-15 19:44:57',	1),
(9,	3,	NULL,	'2014-05-20 16.07.54.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-05-20 16.07.54.jpg',	'2014-05-20 16:07:54',	1),
(10,	3,	NULL,	'2014-05-20 16.35.11.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-05-20 16.35.11.jpg',	'2014-05-20 16:35:11',	1),
(11,	3,	NULL,	'2014-04-22 17.13.24 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-04-22 17.13.24 HDR.jpg',	'2014-04-22 17:13:24',	1),
(12,	7,	41,	'2014-06-22 20.45.20 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-22 20.45.20 HDR.jpg',	'2014-06-22 20:45:20',	1),
(13,	NULL,	41,	'2014-06-24 16.18.59 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-24 16.18.59 HDR.jpg',	'2014-06-24 16:18:59',	1),
(14,	NULL,	41,	'2014-06-24 20.08.42 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-24 20.08.42 HDR.jpg',	'2014-06-24 20:08:42',	1),
(15,	NULL,	41,	'2014-06-27 14.27.48 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-27 14.27.48 HDR.jpg',	'2014-06-27 14:27:48',	1),
(16,	3,	NULL,	'2014-05-28 20.09.21.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-05-28 20.09.21.jpg',	'2014-05-28 20:09:21',	1),
(17,	5,	41,	'2014-06-28 17.25.34 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-28 17.25.34 HDR.jpg',	'2014-06-28 17:25:34',	1),
(18,	6,	41,	'2014-06-29 10.15.14 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-29 10.15.14 HDR.jpg',	'2014-06-29 10:15:14',	1),
(19,	6,	41,	'2014-06-29 10.16.33 HDR.jpg',	'/data/web/virtuals/53977/virtual/www/subdom/anee/app/data/users/1/photos/2014-06-29 10.16.33 HDR.jpg',	'2014-06-29 10:16:33',	1),
...
CREATE TABLE `track` (
  ...
  CONSTRAINT `FK_D6E3F8A69909C13F` FOREIGN KEY (`transport_id`) REFERENCES `transport` (`id`),
  CONSTRAINT `FK_D6E3F8A699435146` FOREIGN KEY (`place_to_id`) REFERENCES `place` (`id`),
  CONSTRAINT `FK_D6E3F8A6A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_D6E3F8A6DA6A219` FOREIGN KEY (`place_id`) REFERENCES `place` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(92,	2,	15,	15,	11,	4021,	0,	'2016-05-28 15:15:00',	1,	1),
(93,	2,	3,	3,	6.5,	0,	0,	'2016-05-06 18:15:00',	1,	0),
(94,	1,	1,	1,	23.81,	3811,	53.09,	'2016-06-03 17:00:00',	1,	0),
(95,	1,	1,	1,	25.07,	0,	53.09,	'2016-05-22 17:00:00',	1,	0);
...
CREATE TABLE `track_user` (
  ...
  CONSTRAINT `FK_10C5FE4C5ED23C43` FOREIGN KEY (`track_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_10C5FE4CA76ED395` FOREIGN KEY (`user_id`) REFERENCES `track` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `transport` (
  ...
  CONSTRAINT `FK_66AB212EA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1,	'ldrahnik',	'ldrahnik',	'ldrahnik@gmail.com',	'$2y$10$MHnn4exi9.RKhzOpbEhYvuHD17Sv/p/FyIfAXqN8bcLMo9rKHGDES',	1,	'Lukáš',	'Drahník',	'2014-06-28 17.25.34 HDR.jpg',	'Anee-redesign-bg.png',	'2016-06-14 18:58:14',	'2016-06-14 16:28:21'),
...
CREATE TABLE `user_user` (
  ...
  CONSTRAINT `FK_F7129A80A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_F7129A80AC24F853` FOREIGN KEY (`follower_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
