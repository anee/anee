...
class ProfilePreview extends Control
{
    ...
    public function __construct(ITransportsModal $ITransportsModal, ThumbnailsHelper $thumbnailsHelper, UserBaseLogic $userBaseLogic, $wwwDir, User $loggedUser, User $profileUser)
    {
